			...
			switch(command) {
				...
				case 'simih':
					...
					if (Number(args[0]) === 1) {
						...
						samih.splice(from, 1)
						fs.writeFileSync('./src/simi.json', JSON.stringify(samih))
						reply('Sucesso ao desativar o modo simi neste grupo️')
					} else {
				...
				case 'welcome':
					...
					if (Number(args[0]) === 1) {
						...
						reply('Ativar com sucesso o recurso de boas-vindas neste grupo️')
					} else if (Number(args[0]) === 0) {
						welkom.splice(from, 1)
						fs.writeFileSync('./src/welkom.json', JSON.stringify(welkom))
						reply('O recurso de boas-vindas foi desativado com sucesso neste grupo️')
					} else {
						reply('1 para ativar, 0 para desativar')
					}
                                      break
